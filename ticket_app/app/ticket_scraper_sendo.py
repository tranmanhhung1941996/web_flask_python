...
def get_post_sendo(sendo_name):
	name = '%2B'.join(sendo_name.lower().split())
...
if __name__ == "__main__":
	sendo_name = raw_input("Event to search for: ")
	results = get_post_sendo(sendo_name)
	for r in results:
		print(r)
